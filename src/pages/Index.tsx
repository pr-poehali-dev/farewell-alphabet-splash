      ...
      <div className="relative flex flex-col items-center min-h-screen py-8 px-4" style={{ zIndex: 10 }}>
        ...
        <div style={{
          ...
          {ALPHABET.map((letter, idx) => {
            ...
            // Буквы только по левой и правой стороне (по ~16-17 с каждой)
            const positions = [
              // Левая сторона (17 букв)
              { x: 0, y: 2  }, { x: 3, y: 8  }, { x: 0, y: 14 }, { x: 3, y: 20 },
              { x: 0, y: 26 }, { x: 3, y: 32 }, { x: 0, y: 38 }, { x: 3, y: 44 },
              { x: 0, y: 50 }, { x: 3, y: 56 }, { x: 0, y: 62 }, { x: 3, y: 68 },
              { x: 0, y: 74 }, { x: 3, y: 80 }, { x: 0, y: 86 }, { x: 3, y: 92 },
              { x: 1, y: 98 },
              // Правая сторона (16 букв)
              { x: 91, y: 2  }, { x: 88, y: 8  }, { x: 91, y: 14 }, { x: 88, y: 20 },
              { x: 91, y: 26 }, { x: 88, y: 32 }, { x: 91, y: 38 }, { x: 88, y: 44 },
              { x: 91, y: 50 }, { x: 88, y: 56 }, { x: 91, y: 62 }, { x: 88, y: 68 },
              { x: 91, y: 74 }, { x: 88, y: 80 }, { x: 91, y: 86 }, { x: 88, y: 92 },
            ];
