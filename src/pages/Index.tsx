      ...
      <div className="relative flex flex-col items-center min-h-screen py-8 px-4" style={{ zIndex: 10 }}>
        ...
        <div style={{
          ...
          {ALPHABET.map((letter, idx) => {
            ...
            // Буквы равномерно по всему периметру
            const positions = [
              // Верхняя сторона (9 букв)
              { x: 1,  y: 1  }, { x: 11, y: 0  }, { x: 21, y: 2  }, { x: 31, y: 0  },
              { x: 41, y: 2  }, { x: 51, y: 0  }, { x: 61, y: 1  }, { x: 71, y: 0  },
              { x: 81, y: 2  },
              // Правая сторона (8 букв)
              { x: 91, y: 3  }, { x: 93, y: 14 }, { x: 91, y: 25 }, { x: 93, y: 36 },
              { x: 91, y: 47 }, { x: 93, y: 58 }, { x: 91, y: 69 }, { x: 93, y: 80 },
              // Нижняя сторона (8 букв)
              { x: 81, y: 91 }, { x: 69, y: 93 }, { x: 57, y: 91 }, { x: 45, y: 93 },
              { x: 33, y: 91 }, { x: 21, y: 93 }, { x: 9,  y: 91 }, { x: 1,  y: 89 },
              // Левая сторона (8 букв)
              { x: 0,  y: 78 }, { x: 2,  y: 67 }, { x: 0,  y: 56 }, { x: 2,  y: 45 },
              { x: 0,  y: 34 }, { x: 2,  y: 23 }, { x: 0,  y: 12 }, { x: 88, y: 91 },
            ];
