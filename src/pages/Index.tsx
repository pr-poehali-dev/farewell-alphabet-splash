      ...
      <div className="relative flex flex-col items-center min-h-screen py-8 px-4" style={{ zIndex: 10 }}>
        ...
        <div style={{
          ...
          {ALPHABET.map((letter, idx) => {
            ...
            // Буквы хаотично слева и справа, без касаний (шаг ~7% по y)
            const positions = [
              // Левая сторона (17 букв) — x от 0 до 8, y с разбросом
              { x: 5, y: 1  }, { x: 1, y: 9  }, { x: 7, y: 17 }, { x: 2, y: 25 },
              { x: 6, y: 33 }, { x: 0, y: 41 }, { x: 8, y: 49 }, { x: 3, y: 57 },
              { x: 6, y: 65 }, { x: 1, y: 73 }, { x: 7, y: 81 }, { x: 2, y: 89 },
              { x: 5, y: 4  }, { x: 0, y: 13 }, { x: 8, y: 22 }, { x: 3, y: 37 },
              { x: 6, y: 61 },
              // Правая сторона (16 букв) — x от 88 до 94
              { x: 90, y: 3  }, { x: 94, y: 11 }, { x: 88, y: 19 }, { x: 93, y: 27 },
              { x: 89, y: 35 }, { x: 94, y: 43 }, { x: 88, y: 51 }, { x: 92, y: 59 },
              { x: 90, y: 67 }, { x: 94, y: 75 }, { x: 88, y: 83 }, { x: 93, y: 91 },
              { x: 91, y: 7  }, { x: 88, y: 23 }, { x: 94, y: 47 }, { x: 90, y: 79 },
            ];
