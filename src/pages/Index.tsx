      ...
      <div className="relative flex flex-col items-center min-h-screen py-8 px-4" style={{ zIndex: 10 }}>
        ...
        <div style={{
          ...
          {ALPHABET.map((letter, idx) => {
            ...
            // 33 буквы хаотично по всей заставке
            const allPos = [
              { x: 3,  y: 2  }, { x: 18, y: 7  }, { x: 35, y: 1  }, { x: 52, y: 5  },
              { x: 68, y: 2  }, { x: 80, y: 8  }, { x: 90, y: 3  }, { x: 8,  y: 18 },
              { x: 28, y: 14 }, { x: 47, y: 20 }, { x: 63, y: 13 }, { x: 76, y: 19 },
              { x: 92, y: 16 }, { x: 2,  y: 33 }, { x: 14, y: 40 }, { x: 32, y: 36 },
            ...
            const pos = allPos[idx] || { x: 50, y: 50 };
