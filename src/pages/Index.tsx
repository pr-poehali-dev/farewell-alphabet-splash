      ...
      <div className="relative flex flex-col items-center min-h-screen py-8 px-4" style={{ zIndex: 10 }}>
        ...
        <div style={{
          ...
          {ALPHABET.map((letter, idx) => {
            ...
            // 33 буквы: 17 слева, 16 справа — шаг 5.5% по y, x с лёгким разбросом
            const positions = [
              // Левая сторона (17 букв), y: 1, 6.5, 12, 17.5, 23, 28.5, 34, 39.5, 45, 50.5, 56, 61.5, 67, 72.5, 78, 83.5, 89
              { x: 4, y: 1   }, { x: 1, y: 6.5 }, { x: 6, y: 12  }, { x: 2, y: 17.5 },
              { x: 5, y: 23  }, { x: 0, y: 28.5}, { x: 7, y: 34  }, { x: 3, y: 39.5 },
              { x: 6, y: 45  }, { x: 1, y: 50.5}, { x: 5, y: 56  }, { x: 2, y: 61.5 },
              { x: 7, y: 67  }, { x: 0, y: 72.5}, { x: 4, y: 78  }, { x: 2, y: 83.5 },
              { x: 6, y: 89  },
              // Правая сторона (16 букв), y: 3.5, 9, 14.5, 20, 25.5, 31, 36.5, 42, 47.5, 53, 58.5, 64, 69.5, 75, 80.5, 86
              { x: 89, y: 3.5 }, { x: 92, y: 9   }, { x: 87, y: 14.5}, { x: 91, y: 20  },
              { x: 88, y: 25.5}, { x: 93, y: 31  }, { x: 87, y: 36.5}, { x: 91, y: 42  },
              { x: 89, y: 47.5}, { x: 93, y: 53  }, { x: 87, y: 58.5}, { x: 92, y: 64  },
              { x: 88, y: 69.5}, { x: 91, y: 75  }, { x: 87, y: 80.5}, { x: 93, y: 86  },
            ];
